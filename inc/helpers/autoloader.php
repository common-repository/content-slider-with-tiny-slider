 ...
 *
 * @package content-sliders-featuers
 */

namespace Content\Slider\Inc\Helpers;
...
function autoloader( $resource = '' ) {
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( TINY_BLOCKS_PATH ), $directory, $file_name );
...
spl_autoload_register( '\Content\Slider\Inc\Helpers\autoloader' );
